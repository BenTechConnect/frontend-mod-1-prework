...
var firstName = "Ben"; // String variable
var isHungry = true; // Boolean variable
var numberOfPets = 0; // Integer variable
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
   /* For the first data type, names are generally all alphabetical characters and therefore we define them as a string.
     The second data type can be seen as having a true or false status, which is called a boolean.
     The final data type is represented by a whole number without a decimal, so it is an Integer and not a Float.*/
// YOU DO:
